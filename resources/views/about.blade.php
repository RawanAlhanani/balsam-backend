                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12 responsive-991-width">
                        ...
                        <div class="eco_blog_detail_post">
                            <figure>
                                     <img class="img-responsive cimage" src="{{asset('storage/MesImages'.'/'.$about->about_image)}}" alt="Photo">
                            </figure>
                            <div class="eco_blog_detail_content">
                                <div style="font-size: 15px;">
                                    @php
                                        $paraphs = explode("---", $about->description) ;
                                ...
                                <div class="eco_share-tag" style="width:40%;">
                                    ...
                                    <ul class="social-icons">
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=https://balsam.ma/aboutUs/{{$about->id}}"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
