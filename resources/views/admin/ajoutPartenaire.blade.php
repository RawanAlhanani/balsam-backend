                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <label for="placeTextarea" class="cursor-pointer card-title">إضافة شريك</label>
                      ...
                      <div class="card-content collapse show">
                        <div class="card-body">
                          ...
                          <form method="post" action="{{route('PostAddPartenaire')}}" enctype="multipart/form-data" >
@csrf
                            <div class="form-body">
                                <div class="row">
                                    <!-- titre -->
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{old('nomPartenaire')}}" type="text" name="nomPartenaire" placeholder="إسم الشريك" class="form-control"/>
                                            @error('nomPartenaire')
