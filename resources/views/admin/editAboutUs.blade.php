                    ...
                    <div class="card">
                      ...
                      <div class="card-content collapse show">
                        <div class="card-body">
                          ...
                          <form method="post" action="{{route('PostEditAboutUs')}}" enctype="multipart/form-data" >
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$AboutUs->titre}}" type="text" name="titre" placeholder="عنوان الصفحة" class="form-control"/>
                                            @error('titre')
                                ...
                                @enderror
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <img src="{{asset('storage/MesImages'.'/'.$AboutUs->about_image)}}" alt="">
                                ...
                                <fieldset>
                                  <div class="input-group input-group-sm">
                                    ...
                                    <textarea name="description" class="form-control"  id="description" rows="10" placeholder="محتوى الخبر"> {{$AboutUs->description}}</textarea>
