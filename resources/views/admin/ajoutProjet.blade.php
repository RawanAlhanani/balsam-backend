                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <label for="placeTextarea" class="cursor-pointer card-title">إاضافة صفحة جديدة ـ مشاريعنا ـ</label>
                      ...
                      <div class="card-content collapse show">
                        <div class="card-body">
                          ...
                          <form method="post" action="{{route('PostAddProjet')}}" enctype="multipart/form-data" >
@csrf
                            <div class="form-body">
                                <div class="row">
                                    <!-- titre -->
                ...
                <div class="card-block">
                  <div class="card-body">
                    <fieldset class="form-group">
                      <textarea class="form-control" name="description" id="placeTextarea" rows="10" placeholder="محتوى الصفحة">{{old('description')}}</textarea>
                      @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    </fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <div class="skin skin-square">
                                                                    <input type="radio" value=-1 name="status" id="radio1" >
                                                                    <label for="radio1">نعم</label>
                                                                </div>
                                                                <div class="skin skin-square">
                                                                    <input type="radio" value=1 name="status" id="radio2" checked>
