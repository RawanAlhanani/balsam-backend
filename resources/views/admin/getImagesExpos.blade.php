                                            ...
                                            @foreach ($images as $item)
                                                <tr>
                                                    <td><img width="250" src="{{asset('storage/MesImages'.'/'.$item->nomImage)}}" /></td>
                                                        ...
                                                        <a href="{{route('EditImageExpo', $item->id)}}" class="btn btn-round btn-warning btn-sm">تعديل</a>
                                                        
                                                        <button id="{{$item->id}}" type="button" data-toggle="modal" data-target="#supprimerImageExpo" class="vouloirSupprImageExpo btn btn-round btn-danger btn-sm">حذف</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
...
<!-- supprimer une info -->
<div class="modal fade text-left" id="supprimerImageExpo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
...
var id = "";
    ...
    $('.vouloirSupprImageExpo').on('click', function() {
        id = $(this).attr("id");
    });
