                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <label for="placeTextarea" class="cursor-pointer card-title">إضافة صورة رئيسية</label>
                      ...
                      <div class="card-content collapse show">
                        <div class="card-body">
                          ...
                          <form method="post" action="{{route('PostAddImagesPrincipales')}}" enctype="multipart/form-data" >
@csrf
                            <div class="form-body">
                                <div class="row">
                                     <!-- Image -->
